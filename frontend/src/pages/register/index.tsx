...
const FileUploadForm = () => {
    ...
    const handleSubmit = async (event) => {
        const url = new URL("http://127.0.0.1:8080/register");
        ...
        <>
            <div className="bg-gray-900 min-h-screen flex flex-col justify-center items-center p-6">
                <div className="w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    { 
                        registered && 
                        <div style={{ color: 'black' }} className="text-center border rounded-lg p-2 bg-slate-200" > Registered Succesfully </div>
                    }
                </div>
            </div>
